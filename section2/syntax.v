...
-> Section 2 of the FTfJP 2024 paper
-> No nominal types
...
Inductive Disj : typ -> typ -> Prop :=
  ...
  | disj_int_arrl : forall A B,
      Disj t_int (t_arrow A B)
  | disj_int_arrr : forall A B,
      Disj (t_arrow A B) t_int
  | disj_null_arrl : forall A B,
      Disj t_unit (t_arrow A B)
  | disj_null_arrr : forall A B,
      Disj (t_arrow A B) t_unit
  | disj_int_nulll :
      Disj t_int t_unit
  | disj_int_nullr :
      Disj t_unit t_int
...
Notation "A *a B" := (Disj A B) (at level 80, B at next level).
...
(*************************************)
(******* Disjointness Soundness ******)
(*************************************)

(** Lemma 2.2 **)
Lemma Disj_sound : forall A B,
  Disj A B -> DisjSpec A B.
Proof.
    unfold DisjSpec.
...
(** Lemma 2.3 **)
Lemma Disj_Complete_size : forall n A B,
  t_size (t_and A B) <= n ->
  DisjSpec A B -> Disj A B.
Proof.
    intros n.
...
Proof.
  ...
  1:{ (*top*)
    ...
    try solve [right; unfold not; 
      ...
      left*. left*. left*.
      right. unfold not. introv Disj.
      apply Disj_sound in Disj.
      apply disj_spec_sym in Disj.
      apply disj_spec_and_uo_inv1 in Disj; auto.
      destruct Disj as [Disj | [Disj | Disj]].
      1,2: apply disj_spec_sym in Disj.
      1,2,3: eapply Disj_Complete_size in Disj; eauto.
      (*case*)
      destruct UOUS as [A1 [A2 UOUS]].
      forwards* (LESS1&LESS2): US_size_red UOUS.
      forwards* Disj1: IHn t_top A1.
      simpl in *. lia.
      forwards* Disj: IHn t_top A2.
      simpl in *. lia.
      destruct Disj1 as [Disj1 | Disj1];
      destruct Disj as [Disj | Disj].
      left*.
      (*proveable*)
      right. unfold not. introv Disj2.
      apply Disj_sound in Disj2.
      forwards* TEMP1: disj_spec_or_uo_inv Disj2.
      destruct TEMP1 as [Disj4 Disj5].
      eapply Disj_Complete_size in Disj5; eauto.
      (*case*)
      right. unfold not. introv Disj2.
      apply Disj_sound in Disj2.
      forwards* TEMP1: disj_spec_or_uo_inv Disj2.
      destruct TEMP1 as [Disj4 Disj5].
      eapply Disj_Complete_size in Disj4; eauto.
      (*case*)
      right. unfold not. introv Disj2.
      apply Disj_sound in Disj2.
      forwards* TEMP1: disj_spec_or_uo_inv Disj2.
  ...
  1:{ (*arrow*)
    ...
    simpl in *. lia.
    forwards* Disj: IHn (t_arrow A1 A2) D2.
    simpl in *. lia.
    destruct Disj1 as [Disj1 | Disj1];
    destruct Disj as [Disj | Disj].
    left*.
  ...
  1:{ (*or*)
    ...
    eapply Disj_Complete_size in Disj3; eauto.
    (*case*)
    right. unfold not. introv Disj.
    apply Disj_sound in Disj.
    apply disj_spec_sym in Disj.
    ...
    apply disj_spec_sym in Disj2;
    apply disj_spec_sym in Disj3.
    eapply Disj_Complete_size in Disj2; eauto.
    (*case*)
    right. unfold not. introv Disj.
    apply Disj_sound in Disj.
    apply disj_spec_sym in Disj.
  ...
  1: { (*and*)
    ...
    simpl in *. lia.
    forwards* Disj: IHn D2 (t_arrow B1 B2).
    simpl in *. lia.
    destruct Disj1 as [Disj1 | Disj1];
    destruct Disj as [Disj | Disj].
    left*.
