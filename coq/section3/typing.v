...
Proof.
  ...
  1: { (*case bot*)
    ...
    apply* disj_botr.
    eapply wft_subst_tb; eauto.
    apply disj_regular in Disj.
    destructs Disj; auto.
  }
  1: { (*case int arrow*)
    simpl.
    apply disj_regular in Disj.
    destruct Disj as [ _ [OKE [WFP WFQ]]].
  ...
  1: { (*case unit arrow*)
    ...
    1: { (*case union*)
    forwards: IHDisj1_1 Disj; auto.
    forwards: IHDisj1_2 Disj; auto.
    apply disj_regular in Disj.
    destructs~ Disj.
  ...
  1:{ (*case and*)
    forwards OK1: ok_from_okt ok.
    forwards (_&_&WFP&WFQ): disj_regular Disj.
  ...
  1: { (*case fvar*)
     ...
     inverts H1.
     forwards: sub_through_subst_tt H0 Disj ok.
     (*
     ...
     rewrite EQ in H1.
     (* proveable *)
     rewrite <- (concat_empty_r E) in Disj.
     apply disj_weakening with (F:=(map (subst_tb Z P) F)) in Disj.
     rewrite concat_empty_r in Disj.
     apply disj_sym in Disj.
     forwards*: sub_disjoint3 Disj H1.
     apply* disj_sym.
     rewrite~ concat_empty_r.
     (*case 2 X <> Z*)
     (* proveable *)
     forwards Sub2: sub_through_subst_tt H0 Disj ok.
     binds_cases H.
     apply disj_fvarl with (T:=T); auto.
     (*
  ...
  1: { (*case fvar*)
     ...
     (* proveable *)
     rewrite <- (concat_empty_r E) in Disj.
     apply disj_weakening with (F:=(map (subst_tb Z P) F)) in Disj; auto.
     rewrite concat_empty_r in Disj.
     apply disj_sym in Disj.
     forwards*: sub_disjoint3 Disj H1.
     rewrite~ concat_empty_r.
  ...
  1:{ (*case P*)
     simpl.
     lets okt: ok_from_okt ok.
     forwards* (_&_&OKP&OKQ): disj_regular Disj.
     apply disj_prim; auto.
